      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <button
              id="header-btn-cliente"
              onClick={() => handleNavClick('/cliente')}
              className="px-3.5 py-2 text-xs font-bold text-slate-700 hover:text-orange-600 rounded-lg hover:bg-orange-50/60 transition-colors flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 text-xs font-bold text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors"
            >
              Entrar
            </button>
            ...
            <button
              ...
              className="px-3.5 py-2 text-xs font-semibold text-slate-600 hover:text-orange-600 hover:bg-orange-50 border border-slate-200 rounded-lg transition-colors cursor-pointer"
            >
              Ver Demo
            </button>
            ...
            <button
              ...
              onClick={() => handleNavClick('/cliente/checkout/conta')}
              className="px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-600 rounded-lg shadow-xs hover:shadow transition-all transform active:scale-95 flex items-center gap-1.5 cursor-pointer"
            >
